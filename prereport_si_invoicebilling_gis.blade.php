...
<body>
    ...
    <table width="100%">
        <thead>
            <tr>
                ...
                <th align="center" colspan="2" width="1%">Amount</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="r" align="right" colspan="2">{{number_format($total,2)}}</td>
            </tr>
            @endforeach
        </tbody>
        <tbody>
          ...
          @endfor
            <tr>
                <td class="b t l r" colspan="3">Sub Total </td>
                <td class="b t l" style="font-weight: bold; border-right:none;">{{$data[0]->CurrencyCode}}</td>
                <td class="b t r" style="border-left: none; text-align:right;">{{number_format($subTotal,2)}}</td>
            </tr>
            <tr>
                <td class="b t l r" colspan="3">Discount </td>
                <td class="b t l" style="font-weight: bold; border-right:none;">{{$data[0]->CurrencyCode}}</td>
                <td class="b t r" style="border-left: none; text-align:right;">{{number_format($data[0]->DiscountAmount,2)}}</td>
            </tr>
            @php $sumTotal = $subTotal - $data[0]->DiscountAmount; @endphp
            <tr>
                <td class="b t l r" colspan="3">TOTAL </td>
    ...
    <p>{{$data[0]->Remark}}<p>
        ...
        <ul>
            <li>We Have SKB 0.5% Cargo Insurance and Goverment Tax in Batam</li>
            <li>All the legal cost will be accrued against you if action is necessary</li>
            <li>Please arrange the remittence by the following Bank Accounts: </br>
                PT.GLOBAL INTERKON SEJAHTERA</br>
                BANK MANDIRI A/C IDR NO: 109-00-877-12345
            </li>
        </ul>
    </br>
    *Jika dalam waktu 5(lima) hari tidak ada sanggahan, maka jumlah diatas kami anggap benar<br>
    dan mohon lampirkan bukti potong pajak 0.5%
        </p>
    <table>
        <tr>
