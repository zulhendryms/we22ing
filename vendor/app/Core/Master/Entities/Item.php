...
class Item extends BaseModel {
    ...
    public function TravelHotelRoomCategoryObj() { return $this->belongsTo("App\Core\Travel\Entities\TravelHotelRoomCategory", "TravelHotelRoomCategory", "Oid"); }
    
    public function ParentObj() { return $this->belongsTo("App\Core\Master\Entities\Item", "ParentOid", "Oid"); }
    ...
    public function POSItemServiceObj() { return $this->hasOne("App\Core\POS\Entities\ItemService", "Oid", "Oid"); }
    ...
    public function Packages() { return $this->hasMany("App\Core\Master\Entities\ItemPackage", "ItemParent", "Oid"); }
    public function Details() { return $this->hasMany("App\Core\Master\Entities\Item", "ParentOid", "Oid"); }
    public function FeatureInfos() { return $this->hasMany("App\Core\POS\Entities\FeatureInfoItem", "Item","Oid"); }
    ...
    public function ETickets() { return $this->hasMany("App\Core\POS\Entities\ETicket", "Item", "Oid"); }
    public function FerryRouteObj() { return $this->belongsTo('App\Core\Ferry\Entities\FerryRoute', 'FerryRoute', 'Oid'); }
    ...
    public function TransportPrices() { return $this->hasMany('App\Core\Travel\Entities\TravelItemTransportPrice', 'Item', 'Oid'); }
}