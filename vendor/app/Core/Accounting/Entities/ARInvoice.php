...
class ARInvoice extends BaseModel {
    ...
    public function Details() { return $this->hasMany("App\Core\Travel\Entities\TravelTransaction", "ARInvoice", "Oid"); }
    public function Journals() { return $this->hasMany("App\Core\Accounting\Entities\Journal", "ARInvoice", "Oid"); }
