...
use App\Core\Accounting\Entities\APInvoice;
...
class APInvoiceService extends JournalObjectService
{
    ...
    public function post($id)
    {
        DB::transaction(function() use ($id) {
            ...
            $arrDefault = [
                ...
                "APInvoice" => "p.Oid",             "Source" => "'Purch-Invoice'",
                "Code" => "p.Code",                 "Date" => "p.Date", 
                "Note" => "p.Note",
            ];
            $fromParentTable =  "accapinvoice p
            ...
            $fromDetailTable =  "trvtransactiondetail d
                LEFT OUTER JOIN accapinvoice p ON p.Oid = d.APInvoice
