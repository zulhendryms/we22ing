...
<hr style="color: #bababa; margin: 15px 0 15px 0;" />
  <div style="font-size: 14px;">
    ...
    <div style="float: right;">
      <div style="color: #a00000; font-size: 22px; font-weight: bold;">{{$pos->CompanyObj->CurrencyObj->Symbol}} {{number_format($pos->TotalAmount, $pos->CompanyObj->CurrencyObj->Decimal)}}</div>
    </div>
    <div style="clear: both;">&nbsp;</div>
    <br />
