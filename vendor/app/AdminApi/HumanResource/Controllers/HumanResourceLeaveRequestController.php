<?php
        ...
        use App\Core\HumanResource\Entities\HumanResourceLeaveRequest;
        use App\Core\Security\Services\RoleModuleService;
        use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

        class HumanResourceLeaveRequestController extends Controller
        {
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function show(HumanResourceLeaveRequest $data) {
            try {
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function destroy(HumanResourceLeaveRequest $data) {
            try {
