<?php
        ...
        use App\Core\HumanResource\Entities\HumanResourceShiftRequest;
        use App\Core\Security\Services\RoleModuleService;
        use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

        class HumanResourceShiftRequestController extends Controller
        {
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function show(HumanResourceShiftRequest $data) {
            try {
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function destroy(HumanResourceShiftRequest $data) {
            try {
