<?php
        ...
        use App\Core\HumanResource\Entities\HumanResourceOvertimeRequest;
        use App\Core\Security\Services\RoleModuleService;
        use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

        class HumanResourceOvertimeRequestController extends Controller
        {
        ...
        public function __construct(
            ...
            {
            $this->module = 'hrsovertimerequest';
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function show(HumanResourceOvertimeRequest $data) {
            try {
...
Response::HTTP_UNPROCESSABLE_ENTITY);
        ...
        public function destroy(HumanResourceOvertimeRequest $data) {
            try {
