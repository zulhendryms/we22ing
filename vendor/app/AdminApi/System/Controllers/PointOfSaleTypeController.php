...
class PointOfSaleTypeController extends Controller
{
    public function index(Request $request)
    {        
        try {            
            $type = $request->input('type') ?: 'combo';
            $data = PointOfSaleType::whereNull('GCRecord');
    ...
    public function show(PointOfSaleType $data)
    {
        try {            
            return $data;
        } catch (\Exception $e) {
    ...
    {        
        ...
        try {            
            if (!$Oid) $data = new PointOfSaleType();
            else $data = PointOfSaleType::findOrFail($Oid);
    ...
    public function destroy(PointOfSaleType $data)
    {
        try {            
