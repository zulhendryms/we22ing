...
class JournalTypeController extends Controller
{
    ...
    {        
        try {            
            ...
            $data = JournalType::whereNull('GCRecord');
    ...
    public function show(JournalType $data)
    {
        try { 
            return $data;
        } catch (\Exception $e) {
    ...
    {        
        ...
        try {            
            if (!$Oid) $data = new JournalType();
            else $data = JournalType::findOrFail($Oid);
    ...
    public function destroy(JournalType $data)
    {
        try {            
