...
class ItemAllotmentController extends Controller
{
    ...
    public function show(ItemAllotment $data)
    {
        try {
    ...
    public function destroy(ItemAllotment $data)
    {
        try {
