...
<head>
  ...
  @php //DECLARATION
    ...
    $fields[] = ['c'=>'Project', 'n'=>'PROJECT'];
    $fields[] = ['c'=>'EmployeeName2', 'n'=>'EMPLOYEE2'];
    ...
    $fieldsDtl[] = ['c'=>'', 'n'=>''];
    $fieldsDtl[] = ['c'=>'ItemName', 'n'=>'Item Name', 'm'=>6];
        ...
        @foreach($data as $row)  
          @php 
            ...
            if ($group1 != $row->Warehouse) { // GROUP 1 //
              ...
              echo "<tr><td colspan='13' class='group'><strong>{$row->Warehouse}</strong></td></tr>";
            ...
            if ($group2 != $row->Code.$row->Oid) { // GROUP 2 //
              ...
              if ($row->Note) echo "<tr><td class='firstcol'></td><td class='lastcol' colspan='12'><strong>NOTE:  {{$row->Note}}</strong></td></tr>";
