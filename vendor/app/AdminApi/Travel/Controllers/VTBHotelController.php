...
use App\Core\Travel\Entities\VTBHotel;
use App\Core\Security\Services\RoleModuleService;
use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

class VTBHotelController extends Controller
{
    ...
    public function show(VTBHotel $data)
    {
        try {
    ...
    public function destroy(VTBHotel $data)
    {
        try {
