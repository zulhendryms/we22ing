...
class ProductionThicknessController extends Controller
{
    ...
    public function show(ProductionThickness $data)
    {
        try {
    ...
    public function destroy(ProductionThickness $data)
    {
        try {
