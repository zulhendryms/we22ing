...
use App\Core\Production\Entities\ProductionUserProcess;
use App\Core\Security\Services\RoleModuleService;
use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

class ProductionUserProcessController extends Controller
{
    ...
    public function show(ProductionUserProcess $data)
    {
        try {
    ...
    public function destroy(ProductionUserProcess $data)
    {
        try {
