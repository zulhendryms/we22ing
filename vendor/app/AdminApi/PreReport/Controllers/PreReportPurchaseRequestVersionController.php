...
class PreReportPurchaseRequestVersionController extends Controller
{
    ...
    {
        $this->reportName = 'prereport-purchaserequestversion';
    ...
    public function report(Request $request, $Oid = null)
    {
        ...
        $pdf = SnappyPdf::loadView('AdminApi\PreReport::pdf.prereport_purchaserequestversion', compact('data'))->setPaper('A4', 'landscape');
