...
class ReportHokindoQuotationController extends Controller
{
    ...
    public function report(Request $request)
    {
        ...
        $criteria2 = $criteria2." AND DATE_FORMAT(po.Date, '%Y-%m-%d') < '".$datefrom->format('Y-m-d')."'";
        $criteria3 = $criteria3." AND DATE_FORMAT(po.Date, '%Y-%m-%d') < '".$datefrom->format('Y-m-d')."'";
