        ...
        <table>
          <thead>
            <tr> {{--width:675px / 525px--}}
              ...
              <th style="width:30px" align="left" >CASHIER</th>
            ...
            <tr> {{--width:675px / 525px--}}
              <th class="firstcol" style="width:40px"></th>
              <th style="width:30px" align="left" colspan="4" >ITEM NAME</th>
              <th style="width:30px" align="left" >QTY</th>
              <th style="width:30px" align="left" >SELL PRICE</th>
              <th style="width:30px" align="left" >%</th>
              <th style="width:100px" align="right" >DISCOUNT</th>
              <th class="lastcol" style="width:100px" align="right" >SUBTOTAL</th>
            </tr>
          </thead>
          <tbody> 
              @php $group=""; $group1=""; $sumsubtotal=0; $sumdiscount=0; $sumtotal=0; @endphp
              @foreach($data as $row)
              @if ($group != $row->Warehouse)
                @if ($group !="")
                  <tr>
                    <td colspan="7" class="total" align="right">Total {{$group}} </td>
                ...
                @endif
                <tr>
                  <td colspan="10" class="group" >{{$row->Warehouse}}</td>
                </tr>
                @php $group = $row->Warehouse; $sumsubtotal=0; $sumdiscount=0; $sumtotal=0; @endphp
              @endif 
              @if ($group1 != $row->Code)
                <tr>
              ...
              @endif
                ...
                <tr>
                  ...
                  <td align="left" colspan="4">{{$row->ItemName}}</td>
                  <td align="right">{{$row->Quantity}} PCS</td>
                  <td align="right">{{$row->Quantity}}</td>
                  <td align="right">{{$row->DiscountPercentage}}</td>
                  <td align="right">{{$row->DiscountAmount}}</td>
                  <td class="lastcol" align="right">{{$row->SubtotalAmount}}</td>
                </tr>
              @endforeach
            </tbody>
            <tr>
