        ...
        <table>
          <thead>
            <tr> {{--width:675px / 525px--}}
              <th class="firstcol" style="width:100px">DATE</th>
              <th style="width:50px" align="left" >QTY</th>
              <th style="width:50px" align="left" >CUR</th>
              <th style="width:150px" align="right" >SUBTOTAL</th>
              <th style="width:150px" align="right" >DISCOUNT</th>
              <th class="lastcol" style="width:150px" align="right" >TOTAL</th>
            </tr>
          </thead>
          <tbody> 
              ...
              @if ($group != $row->GroupName)
                @if ($group !="")
                  <tr>
                    <td colspan="3" class="total" align="right">Total For {{$group}}</td>
                ...
                @endif
                <tr>
                  <td colspan="6" class="group" >{{$row->GroupName}}</td>
                </tr>
                @php $group = $row->GroupName; $sumsubtotal=0; $sumdiscount=0; $sumtotal=0; @endphp
              @endif 
                <tr>
