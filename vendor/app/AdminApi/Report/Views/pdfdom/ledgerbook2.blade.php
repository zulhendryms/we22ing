            ...
            <tbody>
              ...
              @foreach($data as $row)
                @if ($group != $row->Account)
                  @if ($group != "")
                    <tr>
                      <td colspan="4" align="centre">Account :  {{$group}}</td>
                      <td class="total" aligsn="right">{{number_format($sumdebetall ,2,',','.')}}</td>
                      <td class="total" align="right">{{number_format($sumcreditall ,2,',','.')}}</td>
                      <td class="total" align="right">{{number_format($balance ,2,',','.')}}</td>
                    </tr>
                  @endif     
                  <tr>
                    <td colspan="7" class="group" >Account : {{$row->Account}} - {{$row->AccountCode}}</td>
                  </tr>
