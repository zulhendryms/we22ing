...
<body style="margin:0; font-family:Tahoma, Geneva, sans-serif">
    ...
    <main>
        ...
        <thead>
            ...
            <tbody>
              @php $Name1 = ""; $Code1 = ""; $Name2 = ""; $Code2 = ""; $Amount0 = 0; $totalAmount = 0; $group =""; $totalgroup=0; $ProfitLossGroup = ""; $ProfitLossTotal=""; @endphp
              @foreach($data as $row)
               @if ($group !=  $row->Code2 )
                  @if ($group != "")
                    <tr>
                  ...
                  @endif
                  <tr>
                    <td colspan="3" class="group" align="centre">{{ $row->ProfitLossGroup }}</td>
                  </tr>
                  <tr>
                    <td colspan="3" class="group">{{ $row->Name2 }} ( {{ $row->Code2 }} )</td>
                  </tr>
              ...
              @endforeach
              <tr>
                <td colspan="1" align="centre">TOTAL PROFIT</td>
