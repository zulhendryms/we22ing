...
<body style="margin:0; font-family:Tahoma, Geneva, sans-serif">
  <main>
    <table>
      ...
      <tbody>
        @php $Name1 = ""; $Code1 = ""; $balance=0; $group1=""; $totalall =0; $Name2 = ""; $Code2 = ""; $Amount0 = 0; $totalAmount = 0; $ProfitLossGroup = ""; $ProfitLossTotal = ""; $group=""; $totalgroup=0;  @endphp
        @foreach($data as $row)
          @if ($group !=  $row->ProfitLossGroup & $group1 != $row->Name2 )
            ...
            <tr>
              <td colspan="3" class="group" align="centre" style="font-size:14px;"><strong>{{ $row->Name2 }} {{ $row->Code3 }}</strong></td>
            </tr>
            @php $group =  $row->ProfitLossGroup; $balance =0; @endphp
          @endif
          <tr>
            <td>{{ $row->Comp }}</td>
        ...
        <tr>
          <td align="centre"><strong>TOTAL PROFIT</strong></td>
          <td colspan="3" class="total" align="right"><strong>{{number_format($totalall ,2,',','.')}}</strong></td>
        </tr>
      </tbody>
    </table>
