  ...
  <main>
    <table>
      ...
      <tbody>
        @php $group=""; @endphp
        @foreach($data as $row)
          @if ($group != $row->AccountSection )
            <tr>
              <td colspan="5" class="group"><strong>{{$row->AccountSection}}</strong></td>
            </tr>
            <tr>
              <td colspan="5" class="group"><strong>{{$row->AccountGroup}}</strong></td>
            </tr>
            @php $group = $row->AccountSection; @endphp
          @endif
          <tr>
