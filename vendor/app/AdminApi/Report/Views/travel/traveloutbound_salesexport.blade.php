    ...
    <table width="100%">
        <thead>
            <tr>
                ...
                <th width="80px">DEPARTURE DATE</th>
                <th width="120px">CUSTOMER NAME</th>
                <th width="120px">INVOICE AMOUNT</th>
                <th width="120px">SALES PERSON</th>
                <th width="120px">EO NUMBER</th>
                <th width="120px">EO DATE</th>
                <th width="120px">SUPPLIER NAME</th>
                <th width="120px">AMOUNT</th>
                <th width="100px" class="lastcol">NETT PROFIT</th>
            </tr>
        </thead>
        <tbody>
        @foreach($data as $row)
        <tr>
            ...
            <td>{{$row->UserObj->Name}}</td>
            <td>{{$row->Details->Code}}</td>
            <td>{{date('d/m/y', strtotime($row->Details->Date))}}</td>
