...
<body>
    ...
    <table width="100%">
        <thead>
            <tr>
                <th width="80px" class="firstcol">AGENT CODE</th>
                <th width="80px">AGENT NAME</th>
                <th width="120px">RECEIPT NO</th>
                <th width="120px">RECEIVED DATE</th>
                <th width="120px">TYPE OF PAYMENT</th>
                <th width="120px">CURRENCY</th>
                <th width="100px" class="lastcol">AMOUNT RECEIVED</th>
            </tr>
        </thead>
        <tbody>
        @foreach($data as $row)
        <tr>
            <td>{{$row->CustomerObj->Code}}</td>
