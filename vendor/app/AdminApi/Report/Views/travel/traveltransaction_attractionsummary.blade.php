    ...
    <table width="100%">
        <thead>
            <tr>
                ...
                <th width="80px">ADULT</th>
                <th width="120px">CWB</th>
                <th width="120px">CNB</th>
                <th width="120px">ARRIVAL DATE</th>
                <th width="120px">ATTRACTION</th>
                <th width="120px">ISSUED DATE</th>
                <th width="120px">ISSUED BY</th>
                <th width="120px">RETURN DATE</th>
                <th width="120px">RETURN BY</th>
                <th width="100px" class="lastcol">RETURN TICKETS</th>
            </tr>
        </thead>
        <tbody>
        @foreach($data as $row)
        <tr>
            ...
            <td> @php $v = null; try {  $v = $row->ItemObj->Name; } catch (\Exception $ex) {  $err = true; } if ($v) echo $v;@endphp </td>
