...
<body>
    ...
    <table width="100%">
        <thead>
            <tr>
                <th width="80px" class="firstcol">AGENT</th>
                <th width="80px">TOUR CODE</th>
                <th width="120px">ARRIVAL DATE</th>
                <th width="120px">ADT</th>
                <th width="120px">CWB</th>
                <th width="120px">CNB</th>
                <th width="120px">INF</th>
                <th width="120px">TL</th>
                <th width="120px">CURR</th>
                <th width="120px">EX-BED</th>
                <th width="120px">TOUR FARE</th>
                <th width="120px">BALANCE</th>
                <th width="120px">EX-RATE</th>
                <th width="120px">TOUR FARE(SGD)</th>
                <th width="120px">BALANCE-(SGD)</th>
        ...
        <tr>
            ...
            <td>{{$row->QtyInfant}}</td>
            <td>{{$row->QtyTL}}</td>
            <td> @php $v = null; try {  $v = $row->Details->PurchaseCurrencyObj->Code; } catch (\Exception $ex) {  $err = true; } if ($v) echo $v;@endphp </td>
            <td>{{$row->QtyExBed}}</td>
