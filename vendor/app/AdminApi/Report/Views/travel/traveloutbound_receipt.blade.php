...
<body>
    ...
    <table width="100%">
        <thead>
            <tr>
                <th width="80px" class="firstcol">RECEIPT NO</th>
                <th width="80px">RECEIPT DATE</th>
                <th width="120px">CUSTOMER CODE</th>
                <th width="120px">RECEIVED FROM</th>
                <th width="120px">CURR</th>
                <th width="120px">EXCHANGE RATE</th>
                <th width="120px">RECEIVED AMT</th>
                <th width="120px">OUTBOUND INV NO</th>
                <th width="120px">PAID BY</th>
                <th width="120px">REMARKS</th>
                <th width="120px">PAYMENT MODE</th>
                <th width="100px" class="lastcol">BANK TRANSFER</th>
            </tr>
        </thead>
        <tbody>
        @foreach($data as $row)
