...
class ReportTravelStockController extends Controller
{
    ...
    public function report(Request $request, $Oid = null)
    {
      ...
      switch ($reportname) {
        case 'stocklist':
            ...
            $pdf = SnappyPdf::loadView('AdminApi\Report::travel.travelstock_'.$reportname, compact('data', 'dataReport','datefrom','dateto'));
        break;
        case 'stockledger':
            $reporttitle = "Report Stock Ledger";
            $dataReport = (object) [
                "reporttitle" => 'Report Stock Ledger',
                "reportname" => $request->input('report'),
                "CompanyObj" => $user->CompanyObj,
