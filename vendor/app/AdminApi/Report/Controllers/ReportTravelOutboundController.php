...
class ReportTravelOutboundController extends Controller
{
    ...
    {
        $this->reportName = 'traveloutbound';
    ...
    public function report(Request $request, $Oid = null)
    {
        ...
        switch ($reportname) {
            case 'taxinvoice':
                $reporttitle = "Report Outbound Tax Invoice";
                $dataReport = (object) [
                    "reporttitle" => 'Report Outbound Tax Invoice',
                    "reportname" => $request->input('report'),
                ...
                $pdf = SnappyPdf::loadView('AdminApi\Report::travel.traveloutbound_'.$reportname, compact('data', 'dataReport','datefrom','dateto'));
              break;
            case 'exchangeorder':
                $reporttitle = "Report Outbound Exchange Order";
                $dataReport = (object) [
                    "reporttitle" => 'Report Outbound Exchange Order',
                    "reportname" => $request->input('report'),
                    "CompanyObj" => $user->CompanyObj,
            ...
            case 'exchangeorderlist':
                ...
                break;
            case 'receipt':
                $reporttitle = "Report Outbound Receipt";
                $dataReport = (object) [
                    "reporttitle" => 'Report Outbound Receipt',
                    "reportname" => $request->input('report'),
                    "CompanyObj" => $user->CompanyObj,
                ...
                break;
            case 'salesexport':
                $reporttitle = "Report Sales Report";
                $dataReport = (object) [
                    "reporttitle" => 'Report Sales Report',
                    "reportname" => $request->input('report'),
                    "CompanyObj" => $user->CompanyObj,
