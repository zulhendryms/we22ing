...
class AutoNumberSetupController extends Controller
{
    ...
    public function __construct(
        ...
        $this->module = 'sysautonumbersetup';
    ...
    {
        try {
            $data = DB::table($this->module . ' as data')->whereNotNull('TableQuery');
    ...
    public function show(AutoNumberSetup $data)
    {
        try {
    ...
    public function destroy(AutoNumberSetup $data)
    {
        try {
