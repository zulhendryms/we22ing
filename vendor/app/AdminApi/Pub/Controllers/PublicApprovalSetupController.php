...
use App\Core\Pub\Entities\PublicApprovalSetup;
use App\Core\Security\Services\RoleModuleService;
use App\AdminApi\Development\Controllers\CRUDDevelopmentController;

class PublicApprovalSetupController extends Controller
{
    ...
    public function show(PublicApprovalSetup $data)
    {
        try {
    ...
    public function destroy(PublicApprovalSetup $data)
    {
        try {
