...
<body style="margin:0; font-family:Tahoma, Geneva, sans-serif">
  <main>
    <table>
        ...
        @foreach($data as $row)  
          @php 
            ...
            if ($group1 != $row->ItemGroup) { // GROUP 1 //
              if ($group1 != '') echo reportTotal($totalgroup1, 3, $group1);
              echo "<tr><td colspan='10' class='group'><strong>{$row->ItemGroup}</strong></td></tr>";
      ...
      @php 
        echo reportTotal($totalgroup1, 3, $group1);
        echo reportTotal($totalall, 3); 
      @endphp
