...
<head>
  <meta charset="utf-8">
  <title>Faktur Sales Invoice</title>
        ...
        <tbody>
          ...
          @endphp
            <tr>
              ...
              <td class="total" align="right"><strong>SUB TOTAL</strong></td>
              <td class="total" align="right"><strong>{{number_format($sumtotal ,2,',','.')}}</strong></td>
            </tr>
            @if ($row->AdditionalAmount)
            <tr>
